...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.pushButtonComboBox.clicked.connect(self.plainTextEditLog)  # TODO подключить слот для вывода текста из comboBox в plainTextEditLog при нажатии на кнопку
        ...
        self.comboBox.currentTextChanged.connect(self.ComboBoxChange)  # TODO подключить слот для вывода текста в plainTextEditLog при изменении выбранного элемента в comboBox
        self.spinBox.valueChanged.connect(self.SpinBoxChange)  # TODO подключить слот для вывода значения в plainTextEditLog при изменении значения в spinBox
