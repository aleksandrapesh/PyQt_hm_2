...
class Window(QtWidgets.QWidget):
    ...
    def initUi(self) -> None:
        ...
        labelLogin.setText("Логин")   # TODO Создайте виджет QLabel с текстом "Логин"

        labelRegistration = QtWidgets.QLabel()
        labelRegistration.setText("Регистрация")   # TODO Создайте виджет QLabel с текстом "Регистрация"
        ...
        layoutMain.addWidget(layoutLogin) # TODO с помощью метода .addLayout() добавьте layoutLogin
        layoutMain.addWidget(layoutPassword)  # TODO с помощью метода .addLayout() добавьте layoutPassword
        layoutMain.addWidget(layoutButtons)  # TODO с помощью метода .addLayout() добавьте layoutButtons
